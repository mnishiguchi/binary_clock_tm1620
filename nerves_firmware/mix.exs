defmodule BinaryClockTm1620.MixProject do
  use Mix.Project

  @app :binary_clock_tm1620
  @version "0.1.0"
  @all_targets [
    :rpi,
    :rpi0,
  ...
  def application do
    [
      ...
      mod: {BinaryClockTm1620.Application, []}
    ]
  end
  ...
  defp deps do
    [
      ...
      {:resolve, "~> 1.0", only: [:dev, :test], runtime: false},
